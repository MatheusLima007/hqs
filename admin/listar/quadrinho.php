    ...
    <table class="table table-striped table-bordered table-hover" id="tabela">
        ...
        <tbody>
            ...
            $sql = "SELECT q.id, q.titulo, q.capa, q.valor, q.numero, DATE_FORMAT(q.data, '%d/%m/%Y') data, e.nome editora
                    FROM quadrinho q
                    INNER JOIN editora e ON (e.id = q.editora_id) ORDER BY q.titulo
            ";
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a 
                            href="cadastro/quadrinho/<?= $dados->id ?>" 
                            title="Editar Quadrinho <?= $dados->id ?>" 
                            class="btn btn-success btn-sm">
                            <i class="fas fa-edit"></i>
                        </a>
                        <button 
                            class="btn btn-danger btn-sm" 
                            title="Deletar Quadrinho <?= $dados->id ?>" 
