...
<div class="container">
    ...
    <table class="table table-striped table-bordered table-hover" id="tabela">
        ...
        <tbody>
            <?php
                $sql = "SELECT c.id, c.nome, c.cpf, c.email, c.celular, c.endereco, ci.cidade
                        FROM cliente AS c
                        INNER JOIN cidade AS ciON ci.id = c.cidade_id ORDER BY c.nome";
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a 
                            href="cadastro/cliente/<?= $dados->id ?>" 
                            title="Editar Cliente <?= $dados->id ?>" 
                            class="btn btn-success btn-sm">
                            <i class="fas fa-edit"></i>
                        </a>
                        <button 
                            class="btn btn-danger btn-sm" 
                            title="Deletar Cliente <?= $dados->id ?>" 
